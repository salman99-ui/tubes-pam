  ...
  return (
    <View style={{flex:1,  paddingHorizontal : 8}}> 
      <View style={{backgroundColor:'white', height:267, alignItems:'center', borderBottomWidth:2, borderBottomColor:'#B1B1B1'}}>
          <Text style={{fontSize:36, fontWeight:'500', marginTop:30 , color : 'green'}}>Saldo</Text>
          <Text style={{fontSize:36, fontWeight:'500' , color : 'green'}}>${saldo}</Text>
          
      </View>
      <View style="">
        <Text style={{fontSize:22, fontWeight:'500' ,color : 'green'}}>Transaksi Terakhir</Text>
          ...
          <ScrollView style={{ backgroundColor:'white', paddingTop:27}}>
            {
              data.map((items , index) =>(
                ...
                <Text  style={{fontWeight : '700' , fontSize : 14 , color : 'green'}}>Buy {items.name} Price ${items.price}</Text>
